...
<html lang="en">
  ...
  <head>
    ...
    <title>OpenVoPT: Settings > Switches</title>
...
<?php
  // Error checking - If no action was found return to switch management page
  if($_POST["action"] == "") {
    echo '<meta http-equiv="refresh" content ="0; url=s_sw.php">';
  }
...
?>
  ...
  <div class="container">
  <h3><?php echo $_POST["action"].' Switch';?>:</h3>
...
?>
  ...
  <form class="form-horizontal" method="POST" action="s_sw.php">
